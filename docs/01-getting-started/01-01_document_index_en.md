...
## Document Numbering Description

| Number Range | Category | Description |
|--------------|----------|-------------|
| 01-xx | Getting Started | Installation and basic usage |
| 02-xx | Architecture Design | System architecture and technical principles |
| 03-xx | Core Features | CLI commands and core features |
| 04-xx | Extension Development | Plugin development and API |
| 05-xx | Cloud Environment | Cloud deployment and special configuration |
| 06-xx | Monitoring and Performance | Performance optimization and monitoring |
| 07-xx | System Management | Configuration management and operations |
| 08-xx | Project Evaluation | Project evaluation reports |
...
## 05. Cloud Environment Deployment
...
| Number | Document | Description |
|--------|----------|-------------|
| 07-01 | [Config Management Unification](../09-api-reference/09-01_config_management_unification.md) | Unified configuration management solution |
...
| Number | Document | Description |
|--------|----------|-------------|
| 11-01 | [Security Best Practices](../02-installation/02-01_security_best_practices.md) | Production environment security configuration guide |
...
| Number | Document | Description |
|--------|----------|-------------|
| 12-01 | [OpenAPI Specification](../09-api-reference/openapi.yaml) | OpenAPI 3.0 specification file |
...
| Architecture Design | 4 | 2 | 6 |
| Core Features | 2 | 2 | 4 |
| Extension Development | 4 | 2 | 6 |
| Cloud Environment Deployment | 2 | 2 | 4 |
| Monitoring and Performance | 2 | 2 | 4 |
| System Management | 4 | 4 | 8 |
| Project Evaluation | 1 | 1 | 2 |
| Troubleshooting | 1 | 1 | 2 |
| Performance Tuning | 1 | 1 | 2 |
| Security Best Practices | 1 | 1 | 2 |
| API Specification | 0 | 1 | 1 |
| **Total** | **23** | **20** | **43** |
