...
func TestRuleAddAllowCmd(t *testing.T) {
	...
	// Test adding IP to whitelist (allow)
	// 测试添加 IP 到白名单（允许）
...
func TestRuleAddIPPortAllowCmd(t *testing.T) {
	...
	// Test adding IP:Port allow rule
	// 测试添加 IP:端口 允许规则
...
func TestRuleRemoveCmd(t *testing.T) {
	...
	// Test removing IP from blacklist and whitelist
	// 测试从黑名单和白名单移除 IP
	mockBlacklist.On("Remove", "192.168.1.1").Return(nil)
...
func TestRuleAddPort8080Cmd(t *testing.T) {
	...
	// Test adding IP:Port rule for port 8080
	// 测试添加端口 8080 的 IP:端口 规则
...
func TestRuleAddPort22AllowCmd(t *testing.T) {
	...
	// Test adding IP:Port allow rule for SSH
	// 测试添加 SSH 的 IP:端口 允许规则
...
func TestRuleAddPort3306Cmd(t *testing.T) {
	...
	// Test adding IP:Port rule for MySQL
	// 测试添加 MySQL 的 IP:端口 规则
...
func TestRuleAddPort5432AllowCmd(t *testing.T) {
	...
	// Test adding IP:Port allow rule for PostgreSQL
	// 测试添加 PostgreSQL 的 IP:端口 允许规则
