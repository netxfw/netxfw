...
- **BPF映射**: 修复 clearmap 的 nil 指针问题
- **二进制压缩**: 修复重构后的 bin.zst 逻辑问题

## [v1.0.23] - 2026-02-23

### 变更
- **CLI文档**: 更新CLI文档
- **默认设置**: 默认禁用自动更新功能并更新相关文档
- **文档**: 更新README中的下载链接以使用最新版本而不是硬编码版本号
...
### 变更
- **配置**: 完成注释重构并修复字段相关的小问题
- **CI**: 允许 GoReleaser 替换现有制品并修复 v2 弃用问题

## [v1.0.20] - 2026-02-23

### 修复
- **Lint**: 重构 showConntrackHealth 函数以降低复杂度并修复 lint 错误

### 新增
- **系统**: 通过 CLI 添加自动更新支持及增强部署脚本
- **配置**: 在配置模板中恢复默认端口 22 允许规则

## [v1.0.19] - 2026-02-23

### 变更
- **配置**: 清理 DefaultConfigTemplate 中的注释并修复 CLI 中的 nil 上下文 lint 问题
- **CLI**: 增强对 LRU 映射（连接跟踪/动态黑名单）的健康检查逻辑
- **独立版本**: 优化 BPF 路径（位运算/缩放）并重构 Go 配置同步逻辑
