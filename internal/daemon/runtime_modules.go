...
func StartCoreModules(modules []engine.CoreModule, globalCfg *sdk.GlobalConfig, s *sdk.SDK, log *zap.SugaredLogger) error {
...
func StartDefaultRuntimeCore(globalCfg *sdk.GlobalConfig, s *sdk.SDK, log *zap.SugaredLogger) ([]engine.CoreModule, error) {
...
func ReloadCoreModules(modules []engine.CoreModule, globalCfg *sdk.GlobalConfig, log *zap.SugaredLogger) {
	for _, mod := range modules {
